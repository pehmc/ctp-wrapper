...
void TdApi::OnRtnPrivateSeqNo(int nSeqNo) 
{
	Task task = Task();
	task.task_name = ONRTNPRIVATESEQNO;
	task.task_id = nSeqNo;
	this->task_queue.push(task);
};
...
void TdApi::OnRspGenSMSCode(CThostFtdcRspGenSMSCodeField *pRspGenSMSCode, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPGENSMSCODE;
	if (pRspGenSMSCode)
	{
		CThostFtdcRspGenSMSCodeField *task_data = new CThostFtdcRspGenSMSCodeField();
		*task_data = *pRspGenSMSCode;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspSpdApply(CThostFtdcInputSpdApplyField *pInputSpdApply, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPSPDAPPLY;
	if (pInputSpdApply)
	{
		CThostFtdcInputSpdApplyField *task_data = new CThostFtdcInputSpdApplyField();
		*task_data = *pInputSpdApply;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspSpdApplyAction(CThostFtdcInputSpdApplyActionField *pInputSpdApplyAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPSPDAPPLYACTION;
	if (pInputSpdApplyAction)
	{
		CThostFtdcInputSpdApplyActionField *task_data = new CThostFtdcInputSpdApplyActionField();
		*task_data = *pInputSpdApplyAction;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspQrySpdApply(CThostFtdcSpdApplyField *pSpdApply, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPQRYSPDAPPLY;
	if (pSpdApply)
	{
		CThostFtdcSpdApplyField *task_data = new CThostFtdcSpdApplyField();
		*task_data = *pSpdApply;
		task.task_data = task_data;
	}
	if (pRspInfo)
...
void TdApi::OnRtnSpdApply(CThostFtdcSpdApplyField *pSpdApply) 
{
	Task task = Task();
	task.task_name = ONRTNSPDAPPLY;
	if (pSpdApply)
	{
		CThostFtdcSpdApplyField *task_data = new CThostFtdcSpdApplyField();
		*task_data = *pSpdApply;
...
void TdApi::OnErrRtnSpdApply(CThostFtdcInputSpdApplyField *pInputSpdApply, CThostFtdcRspInfoField *pRspInfo) 
{
	Task task = Task();
	task.task_name = ONERRRTNSPDAPPLY;
	if (pInputSpdApply)
	{
		CThostFtdcInputSpdApplyField *task_data = new CThostFtdcInputSpdApplyField();
		*task_data = *pInputSpdApply;
...
void TdApi::OnErrRtnSpdApplyAction(CThostFtdcSpdApplyActionField *pSpdApplyAction, CThostFtdcRspInfoField *pRspInfo) 
{
	Task task = Task();
	task.task_name = ONERRRTNSPDAPPLYACTION;
	if (pSpdApplyAction)
	{
		CThostFtdcSpdApplyActionField *task_data = new CThostFtdcSpdApplyActionField();
		*task_data = *pSpdApplyAction;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspHedgeCfm(CThostFtdcInputHedgeCfmField *pInputHedgeCfm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPHEDGECFM;
	if (pInputHedgeCfm)
	{
		CThostFtdcInputHedgeCfmField *task_data = new CThostFtdcInputHedgeCfmField();
		*task_data = *pInputHedgeCfm;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspHedgeCfmAction(CThostFtdcInputHedgeCfmActionField *pInputHedgeCfmAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPHEDGECFMACTION;
	if (pInputHedgeCfmAction)
	{
		CThostFtdcInputHedgeCfmActionField *task_data = new CThostFtdcInputHedgeCfmActionField();
		*task_data = *pInputHedgeCfmAction;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::OnRspQryHedgeCfm(CThostFtdcHedgeCfmField *pHedgeCfm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	Task task = Task();
	task.task_name = ONRSPQRYHEDGECFM;
	if (pHedgeCfm)
	{
		CThostFtdcHedgeCfmField *task_data = new CThostFtdcHedgeCfmField();
		*task_data = *pHedgeCfm;
		task.task_data = task_data;
	}
	if (pRspInfo)
...
void TdApi::OnRtnHedgeCfm(CThostFtdcHedgeCfmField *pHedgeCfm) 
{
	Task task = Task();
	task.task_name = ONRTNHEDGECFM;
	if (pHedgeCfm)
	{
		CThostFtdcHedgeCfmField *task_data = new CThostFtdcHedgeCfmField();
		*task_data = *pHedgeCfm;
...
void TdApi::OnErrRtnHedgeCfm(CThostFtdcInputHedgeCfmField *pInputHedgeCfm, CThostFtdcRspInfoField *pRspInfo) 
{
	Task task = Task();
	task.task_name = ONERRRTNHEDGECFM;
	if (pInputHedgeCfm)
	{
		CThostFtdcInputHedgeCfmField *task_data = new CThostFtdcInputHedgeCfmField();
		*task_data = *pInputHedgeCfm;
...
void TdApi::OnErrRtnHedgeCfmAction(CThostFtdcHedgeCfmActionField *pHedgeCfmAction, CThostFtdcRspInfoField *pRspInfo) 
{
	Task task = Task();
	task.task_name = ONERRRTNHEDGECFMACTION;
	if (pHedgeCfmAction)
	{
		CThostFtdcHedgeCfmActionField *task_data = new CThostFtdcHedgeCfmActionField();
		*task_data = *pHedgeCfmAction;
		task.task_data = task_data;
	}
	if (pRspInfo)
	{
...
void TdApi::processTask()
{
	try
	{
		while (this->active)
		{
			...
			case ONRTNPRIVATESEQNO:
			{
				this->processRtnPrivateSeqNo(&task);
				break;
			}
			...
			case ONRSPGENSMSCODE:
			{
				this->processRspGenSMSCode(&task);
				break;
			}

			case ONRSPSPDAPPLY:
			{
				this->processRspSpdApply(&task);
				break;
			}

			case ONRSPSPDAPPLYACTION:
			{
				this->processRspSpdApplyAction(&task);
				break;
			}

			case ONRSPQRYSPDAPPLY:
			{
				this->processRspQrySpdApply(&task);
				break;
			}

			case ONRTNSPDAPPLY:
			{
				this->processRtnSpdApply(&task);
				break;
			}

			case ONERRRTNSPDAPPLY:
			{
				this->processErrRtnSpdApply(&task);
				break;
			}

			case ONERRRTNSPDAPPLYACTION:
			{
				this->processErrRtnSpdApplyAction(&task);
				break;
			}

			case ONRSPHEDGECFM:
			{
				this->processRspHedgeCfm(&task);
				break;
			}

			case ONRSPHEDGECFMACTION:
			{
				this->processRspHedgeCfmAction(&task);
				break;
			}

			case ONRSPQRYHEDGECFM:
			{
				this->processRspQryHedgeCfm(&task);
				break;
			}

			case ONRTNHEDGECFM:
			{
				this->processRtnHedgeCfm(&task);
				break;
			}

			case ONERRRTNHEDGECFM:
			{
				this->processErrRtnHedgeCfm(&task);
				break;
			}

			case ONERRRTNHEDGECFMACTION:
			{
				this->processErrRtnHedgeCfmAction(&task);
				break;
			}
			};
		}
...
void TdApi::processRtnPrivateSeqNo(Task *task)
{
	gil_scoped_acquire acquire;
	this->onRtnPrivateSeqNo(task->task_id);
};
...
void TdApi::processRspQryContractBank(Task *task)
{
	...
	if (task->task_data)
	{
		...
		data["BankBrchID"] = toUtf(task_data->BankBrchID);
		data["BankName"] = toUtf(task_data->BankName);
		data["csrcBankID"] = toUtf(task_data->csrcBankID);
		delete task_data;
	}
	dict error;
	if (task->task_error)
...
void TdApi::processRspGenSMSCode(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcRspGenSMSCodeField *task_data = (CThostFtdcRspGenSMSCodeField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["UserID"] = toUtf(task_data->UserID);
		data["GenTime"] = toUtf(task_data->GenTime);
		delete task_data;
	}
	dict error;
	if (task->task_error)
	...
	this->onRspGenSMSCode(data, error, task->task_id, task->task_last);
};

void TdApi::processRspSpdApply(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcInputSpdApplyField *task_data = (CThostFtdcInputSpdApplyField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["UserID"] = toUtf(task_data->UserID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ExchangeID"] = toUtf(task_data->ExchangeID);
		data["FirstLegInstrumentID"] = toUtf(task_data->FirstLegInstrumentID);
		data["SecondLegInstrumentID"] = toUtf(task_data->SecondLegInstrumentID);
		data["Volume"] = task_data->Volume;
		data["Direction"] = task_data->Direction;
		data["CmbType"] = task_data->CmbType;
		data["RequestID"] = task_data->RequestID;
		data["OrderRef"] = toUtf(task_data->OrderRef);
		data["IPAddress"] = toUtf(task_data->IPAddress);
		data["MacAddress"] = toUtf(task_data->MacAddress);
	...
	this->onRspSpdApply(data, error, task->task_id, task->task_last);
};

void TdApi::processRspSpdApplyAction(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcInputSpdApplyActionField *task_data = (CThostFtdcInputSpdApplyActionField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["UserID"] = toUtf(task_data->UserID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ExchangeID"] = toUtf(task_data->ExchangeID);
	...
	this->onRspSpdApplyAction(data, error, task->task_id, task->task_last);
};

void TdApi::processRspQrySpdApply(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcSpdApplyField *task_data = (CThostFtdcSpdApplyField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["FirstLegInstrumentID"] = toUtf(task_data->FirstLegInstrumentID);
		data["SecondLegInstrumentID"] = toUtf(task_data->SecondLegInstrumentID);
	...
	this->onRspQrySpdApply(data, error, task->task_id, task->task_last);
};

void TdApi::processRtnSpdApply(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	...
	this->onRtnSpdApply(data);
};

void TdApi::processErrRtnSpdApply(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	...
	this->onErrRtnSpdApply(data, error);
};

void TdApi::processErrRtnSpdApplyAction(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcSpdApplyActionField *task_data = (CThostFtdcSpdApplyActionField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ActionDate"] = toUtf(task_data->ActionDate);
		data["ActionTime"] = toUtf(task_data->ActionTime);
	...
	this->onErrRtnSpdApplyAction(data, error);
};

void TdApi::processRspHedgeCfm(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcInputHedgeCfmField *task_data = (CThostFtdcInputHedgeCfmField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["UserID"] = toUtf(task_data->UserID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ExchangeID"] = toUtf(task_data->ExchangeID);
	...
	this->onRspHedgeCfm(data, error, task->task_id, task->task_last);
};

void TdApi::processRspHedgeCfmAction(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcInputHedgeCfmActionField *task_data = (CThostFtdcInputHedgeCfmActionField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["UserID"] = toUtf(task_data->UserID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ExchangeID"] = toUtf(task_data->ExchangeID);
	...
	this->onRspHedgeCfmAction(data, error, task->task_id, task->task_last);
};

void TdApi::processRspQryHedgeCfm(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcHedgeCfmField *task_data = (CThostFtdcHedgeCfmField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["InstrumentID"] = toUtf(task_data->InstrumentID);
		data["UserID"] = toUtf(task_data->UserID);
		...
		data["ApplyStatus"] = task_data->ApplyStatus;
		data["SequenceNo"] = task_data->SequenceNo;
		data["DealVolume"] = task_data->DealVolume;
		data["InsertDate"] = toUtf(task_data->InsertDate);
		data["InsertTime"] = toUtf(task_data->InsertTime);
		data["CancelTime"] = toUtf(task_data->CancelTime);
		data["ReqDate"] = toUtf(task_data->ReqDate);
		data["OrderLocalID"] = toUtf(task_data->OrderLocalID);
		data["ExchangeID"] = toUtf(task_data->ExchangeID);
		data["ParticipantID"] = toUtf(task_data->ParticipantID);
		data["ClientID"] = toUtf(task_data->ClientID);
	...
	this->onRspQryHedgeCfm(data, error, task->task_id, task->task_last);
};

void TdApi::processRtnHedgeCfm(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	...
	this->onRtnHedgeCfm(data);
};

void TdApi::processErrRtnHedgeCfm(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	...
	this->onErrRtnHedgeCfm(data, error);
};

void TdApi::processErrRtnHedgeCfmAction(Task *task)
{
	gil_scoped_acquire acquire;
	dict data;
	if (task->task_data)
	{
		CThostFtdcHedgeCfmActionField *task_data = (CThostFtdcHedgeCfmActionField*)task->task_data;
		data["BrokerID"] = toUtf(task_data->BrokerID);
		data["InvestorID"] = toUtf(task_data->InvestorID);
		data["ActionDate"] = toUtf(task_data->ActionDate);
		data["ActionTime"] = toUtf(task_data->ActionTime);
	...
	this->onErrRtnHedgeCfmAction(data, error);
};
...
int TdApi::reqUserLogin(const dict &req, int reqid)
{
	...
	getString(req, "SMSCode", myreq.SMSCode);
...
int TdApi::reqGenSMSCode(const dict &req, int reqid)
{
	CThostFtdcReqGenSMSCodeField myreq = CThostFtdcReqGenSMSCodeField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "UserID", myreq.UserID);
	getString(req, "Mobile", myreq.Mobile);
	int i = this->api->ReqGenSMSCode(&myreq, reqid);
	return i;
};

int TdApi::reqSpdApply(const dict &req, int reqid)
{
	CThostFtdcInputSpdApplyField myreq = CThostFtdcInputSpdApplyField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "UserID", myreq.UserID);
	getString(req, "InvestorID", myreq.InvestorID);
	getString(req, "ExchangeID", myreq.ExchangeID);
	getString(req, "FirstLegInstrumentID", myreq.FirstLegInstrumentID);
	getString(req, "SecondLegInstrumentID", myreq.SecondLegInstrumentID);
	getInt(req, "Volume", &myreq.Volume);
	getChar(req, "Direction", &myreq.Direction);
	getChar(req, "CmbType", &myreq.CmbType);
	getInt(req, "RequestID", &myreq.RequestID);
	getString(req, "OrderRef", myreq.OrderRef);
	getString(req, "IPAddress", myreq.IPAddress);
	getString(req, "MacAddress", myreq.MacAddress);
	int i = this->api->ReqSpdApply(&myreq, reqid);
	return i;
};

int TdApi::reqSpdApplyAction(const dict &req, int reqid)
{
	CThostFtdcInputSpdApplyActionField myreq = CThostFtdcInputSpdApplyActionField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "UserID", myreq.UserID);
	getString(req, "InvestorID", myreq.InvestorID);
	...
	getString(req, "IPAddress", myreq.IPAddress);
	getString(req, "MacAddress", myreq.MacAddress);
	int i = this->api->ReqSpdApplyAction(&myreq, reqid);
	return i;
};

int TdApi::reqQrySpdApply(const dict &req, int reqid)
{
	CThostFtdcQrySpdApplyField myreq = CThostFtdcQrySpdApplyField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "InvestorID", myreq.InvestorID);
	getString(req, "ExchangeID", myreq.ExchangeID);
	...
	getString(req, "FirstLegInstrumentID", myreq.FirstLegInstrumentID);
	getString(req, "SecondLegInstrumentID", myreq.SecondLegInstrumentID);
	int i = this->api->ReqQrySpdApply(&myreq, reqid);
	return i;
};

int TdApi::reqHedgeCfm(const dict &req, int reqid)
{
	CThostFtdcInputHedgeCfmField myreq = CThostFtdcInputHedgeCfmField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "UserID", myreq.UserID);
	getString(req, "InvestorID", myreq.InvestorID);
	...
	getString(req, "IPAddress", myreq.IPAddress);
	getString(req, "MacAddress", myreq.MacAddress);
	int i = this->api->ReqHedgeCfm(&myreq, reqid);
	return i;
};

int TdApi::reqHedgeCfmAction(const dict &req, int reqid)
{
	CThostFtdcInputHedgeCfmActionField myreq = CThostFtdcInputHedgeCfmActionField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "UserID", myreq.UserID);
	getString(req, "InvestorID", myreq.InvestorID);
	...
	getString(req, "IPAddress", myreq.IPAddress);
	getString(req, "MacAddress", myreq.MacAddress);
	int i = this->api->ReqHedgeCfmAction(&myreq, reqid);
	return i;
};

int TdApi::reqQryHedgeCfm(const dict &req, int reqid)
{
	CThostFtdcQryHedgeCfmField myreq = CThostFtdcQryHedgeCfmField();
	memset(&myreq, 0, sizeof(myreq));
	getString(req, "BrokerID", myreq.BrokerID);
	getString(req, "InvestorID", myreq.InvestorID);
	getString(req, "ExchangeID", myreq.ExchangeID);
	getString(req, "OrderSysID", myreq.OrderSysID);
	getString(req, "InstrumentID", myreq.InstrumentID);
	int i = this->api->ReqQryHedgeCfm(&myreq, reqid);
	return i;
};
...
public:
	...
	void onRtnPrivateSeqNo(int reqid) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRtnPrivateSeqNo, reqid);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspGenSMSCode(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspGenSMSCode, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspSpdApply(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspSpdApply, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspSpdApplyAction(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspSpdApplyAction, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspQrySpdApply(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspQrySpdApply, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRtnSpdApply(const dict &data) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRtnSpdApply, data);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onErrRtnSpdApply(const dict &data, const dict &error) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onErrRtnSpdApply, data, error);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onErrRtnSpdApplyAction(const dict &data, const dict &error) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onErrRtnSpdApplyAction, data, error);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspHedgeCfm(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspHedgeCfm, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspHedgeCfmAction(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspHedgeCfmAction, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRspQryHedgeCfm(const dict &data, const dict &error, int reqid, bool last) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRspQryHedgeCfm, data, error, reqid, last);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onRtnHedgeCfm(const dict &data) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onRtnHedgeCfm, data);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onErrRtnHedgeCfm(const dict &data, const dict &error) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onErrRtnHedgeCfm, data, error);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
	...
	void onErrRtnHedgeCfmAction(const dict &data, const dict &error) override
	{
		try
		{
			PYBIND11_OVERLOAD(void, TdApi, onErrRtnHedgeCfmAction, data, error);
		}
		catch (const error_already_set &e)
		{
			cout << e.what() << endl;
...
PYBIND11_MODULE(ctptd, m)
{
	...
	tdApi
		...
		.def("reqGenSMSCode", &TdApi::reqGenSMSCode)
		.def("reqSpdApply", &TdApi::reqSpdApply)
		.def("reqSpdApplyAction", &TdApi::reqSpdApplyAction)
		.def("reqQrySpdApply", &TdApi::reqQrySpdApply)
		.def("reqHedgeCfm", &TdApi::reqHedgeCfm)
		.def("reqHedgeCfmAction", &TdApi::reqHedgeCfmAction)
		.def("reqQryHedgeCfm", &TdApi::reqQryHedgeCfm)
		...
		.def("onRtnPrivateSeqNo", &TdApi::onRtnPrivateSeqNo)
		...
		.def("onRspGenSMSCode", &TdApi::onRspGenSMSCode)
		.def("onRspSpdApply", &TdApi::onRspSpdApply)
		.def("onRspSpdApplyAction", &TdApi::onRspSpdApplyAction)
		.def("onRspQrySpdApply", &TdApi::onRspQrySpdApply)
		.def("onRtnSpdApply", &TdApi::onRtnSpdApply)
		.def("onErrRtnSpdApply", &TdApi::onErrRtnSpdApply)
		.def("onErrRtnSpdApplyAction", &TdApi::onErrRtnSpdApplyAction)
		.def("onRspHedgeCfm", &TdApi::onRspHedgeCfm)
		.def("onRspHedgeCfmAction", &TdApi::onRspHedgeCfmAction)
		.def("onRspQryHedgeCfm", &TdApi::onRspQryHedgeCfm)
		.def("onRtnHedgeCfm", &TdApi::onRtnHedgeCfm)
		.def("onErrRtnHedgeCfm", &TdApi::onErrRtnHedgeCfm)
		.def("onErrRtnHedgeCfmAction", &TdApi::onErrRtnHedgeCfmAction)
		;
}
