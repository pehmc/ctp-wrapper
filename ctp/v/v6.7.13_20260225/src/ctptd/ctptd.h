...
#define ONRSPQRYMAXORDERVOLUME 16
...
#define ONRSPQRYUSERSESSION 37
#define ONRSPQRYEXCHANGE 38
#define ONRSPQRYPRODUCT 39
#define ONRSPQRYINSTRUMENT 40
#define ONRSPQRYDEPTHMARKETDATA 41
#define ONRSPQRYTRADEROFFER 42
#define ONRSPQRYSETTLEMENTINFO 43
#define ONRSPQRYTRANSFERBANK 44
#define ONRSPQRYINVESTORPOSITIONDETAIL 45
#define ONRSPQRYNOTICE 46
#define ONRSPQRYSETTLEMENTINFOCONFIRM 47
#define ONRSPQRYINVESTORPOSITIONCOMBINEDETAIL 48
#define ONRSPQRYCFMMCTRADINGACCOUNTKEY 49
#define ONRSPQRYEWARRANTOFFSET 50
#define ONRSPQRYINVESTORPRODUCTGROUPMARGIN 51
#define ONRSPQRYEXCHANGEMARGINRATE 52
#define ONRSPQRYEXCHANGEMARGINRATEADJUST 53
#define ONRSPQRYEXCHANGERATE 54
#define ONRSPQRYSECAGENTACIDMAP 55
#define ONRSPQRYPRODUCTEXCHRATE 56
#define ONRSPQRYPRODUCTGROUP 57
#define ONRSPQRYMMINSTRUMENTCOMMISSIONRATE 58
#define ONRSPQRYMMOPTIONINSTRCOMMRATE 59
#define ONRSPQRYINSTRUMENTORDERCOMMRATE 60
#define ONRSPQRYSECAGENTTRADINGACCOUNT 61
#define ONRSPQRYSECAGENTCHECKMODE 62
#define ONRSPQRYSECAGENTTRADEINFO 63
#define ONRSPQRYOPTIONINSTRTRADECOST 64
#define ONRSPQRYOPTIONINSTRCOMMRATE 65
#define ONRSPQRYEXECORDER 66
#define ONRSPQRYFORQUOTE 67
#define ONRSPQRYQUOTE 68
#define ONRSPQRYOPTIONSELFCLOSE 69
#define ONRSPQRYINVESTUNIT 70
#define ONRSPQRYCOMBINSTRUMENTGUARD 71
#define ONRSPQRYCOMBACTION 72
#define ONRSPQRYTRANSFERSERIAL 73
#define ONRSPQRYACCOUNTREGISTER 74
#define ONRSPERROR 75
#define ONRTNORDER 76
#define ONRTNTRADE 77
#define ONERRRTNORDERINSERT 78
#define ONERRRTNORDERACTION 79
#define ONRTNINSTRUMENTSTATUS 80
#define ONRTNBULLETIN 81
#define ONRTNTRADINGNOTICE 82
#define ONRTNERRORCONDITIONALORDER 83
#define ONRTNEXECORDER 84
#define ONERRRTNEXECORDERINSERT 85
#define ONERRRTNEXECORDERACTION 86
#define ONERRRTNFORQUOTEINSERT 87
#define ONRTNQUOTE 88
#define ONERRRTNQUOTEINSERT 89
#define ONERRRTNQUOTEACTION 90
#define ONRTNFORQUOTERSP 91
#define ONRTNCFMMCTRADINGACCOUNTTOKEN 92
#define ONERRRTNBATCHORDERACTION 93
#define ONRTNOPTIONSELFCLOSE 94
#define ONERRRTNOPTIONSELFCLOSEINSERT 95
#define ONERRRTNOPTIONSELFCLOSEACTION 96
#define ONRTNCOMBACTION 97
#define ONERRRTNCOMBACTIONINSERT 98
#define ONRSPQRYCONTRACTBANK 99
#define ONRSPQRYPARKEDORDER 100
#define ONRSPQRYPARKEDORDERACTION 101
#define ONRSPQRYTRADINGNOTICE 102
#define ONRSPQRYBROKERTRADINGPARAMS 103
#define ONRSPQRYBROKERTRADINGALGOS 104
#define ONRSPQUERYCFMMCTRADINGACCOUNTTOKEN 105
#define ONRTNFROMBANKTOFUTUREBYBANK 106
#define ONRTNFROMFUTURETOBANKBYBANK 107
#define ONRTNREPEALFROMBANKTOFUTUREBYBANK 108
#define ONRTNREPEALFROMFUTURETOBANKBYBANK 109
#define ONRTNFROMBANKTOFUTUREBYFUTURE 110
#define ONRTNFROMFUTURETOBANKBYFUTURE 111
#define ONRTNREPEALFROMBANKTOFUTUREBYFUTUREMANUAL 112
#define ONRTNREPEALFROMFUTURETOBANKBYFUTUREMANUAL 113
#define ONRTNQUERYBANKBALANCEBYFUTURE 114
#define ONERRRTNBANKTOFUTUREBYFUTURE 115
#define ONERRRTNFUTURETOBANKBYFUTURE 116
#define ONERRRTNREPEALBANKTOFUTUREBYFUTUREMANUAL 117
#define ONERRRTNREPEALFUTURETOBANKBYFUTUREMANUAL 118
#define ONERRRTNQUERYBANKBALANCEBYFUTURE 119
#define ONRTNREPEALFROMBANKTOFUTUREBYFUTURE 120
#define ONRTNREPEALFROMFUTURETOBANKBYFUTURE 121
#define ONRSPFROMBANKTOFUTUREBYFUTURE 122
#define ONRSPFROMFUTURETOBANKBYFUTURE 123
#define ONRSPQUERYBANKACCOUNTMONEYBYFUTURE 124
#define ONRTNOPENACCOUNTBYBANK 125
#define ONRTNCANCELACCOUNTBYBANK 126
#define ONRTNCHANGEACCOUNTBYBANK 127
#define ONRSPQRYCLASSIFIEDINSTRUMENT 128
#define ONRSPQRYCOMBPROMOTIONPARAM 129
#define ONRSPQRYRISKSETTLEINVSTPOSITION 130
#define ONRSPQRYRISKSETTLEPRODUCTSTATUS 131
#define ONRSPQRYSPBMFUTUREPARAMETER 132
#define ONRSPQRYSPBMOPTIONPARAMETER 133
#define ONRSPQRYSPBMINTRAPARAMETER 134
#define ONRSPQRYSPBMINTERPARAMETER 135
#define ONRSPQRYSPBMPORTFDEFINITION 136
#define ONRSPQRYSPBMINVESTORPORTFDEF 137
#define ONRSPQRYINVESTORPORTFMARGINRATIO 138
#define ONRSPQRYINVESTORPRODSPBMDETAIL 139
#define ONRSPQRYINVESTORCOMMODITYSPMMMARGIN 140
#define ONRSPQRYINVESTORCOMMODITYGROUPSPMMMARGIN 141
#define ONRSPQRYSPMMINSTPARAM 142
#define ONRSPQRYSPMMPRODUCTPARAM 143
#define ONRSPQRYSPBMADDONINTERPARAMETER 144
#define ONRSPQRYRCAMSCOMBPRODUCTINFO 145
#define ONRSPQRYRCAMSINSTRPARAMETER 146
#define ONRSPQRYRCAMSINTRAPARAMETER 147
#define ONRSPQRYRCAMSINTERPARAMETER 148
#define ONRSPQRYRCAMSSHORTOPTADJUSTPARAM 149
#define ONRSPQRYRCAMSINVESTORCOMBPOSITION 150
#define ONRSPQRYINVESTORPRODRCAMSMARGIN 151
#define ONRSPQRYRULEINSTRPARAMETER 152
#define ONRSPQRYRULEINTRAPARAMETER 153
#define ONRSPQRYRULEINTERPARAMETER 154
#define ONRSPQRYINVESTORPRODRULEMARGIN 155
#define ONRSPQRYINVESTORPORTFSETTING 156
#define ONRSPQRYINVESTORINFOCOMMREC 157
#define ONRSPQRYCOMBLEG 158
#define ONRSPOFFSETSETTING 159
#define ONRSPCANCELOFFSETSETTING 160
#define ONRTNOFFSETSETTING 161
#define ONERRRTNOFFSETSETTING 162
#define ONERRRTNCANCELOFFSETSETTING 163
#define ONRSPQRYOFFSETSETTING 164
#define ONRSPGENSMSCODE 165
#define ONRSPSPDAPPLY 166
#define ONRSPSPDAPPLYACTION 167
#define ONRSPQRYSPDAPPLY 168
#define ONRTNSPDAPPLY 169
#define ONERRRTNSPDAPPLY 170
#define ONERRRTNSPDAPPLYACTION 171
#define ONRSPHEDGECFM 172
#define ONRSPHEDGECFMACTION 173
#define ONRSPQRYHEDGECFM 174
#define ONRTNHEDGECFM 175
#define ONERRRTNHEDGECFM 176
#define ONERRRTNHEDGECFMACTION 177
...
public:
	...
	void processRtnPrivateSeqNo(Task *task);
	...
	void processRspGenSMSCode(Task *task);

	void processRspSpdApply(Task *task);

	void processRspSpdApplyAction(Task *task);

	void processRspQrySpdApply(Task *task);

	void processRtnSpdApply(Task *task);

	void processErrRtnSpdApply(Task *task);

	void processErrRtnSpdApplyAction(Task *task);

	void processRspHedgeCfm(Task *task);

	void processRspHedgeCfmAction(Task *task);

	void processRspQryHedgeCfm(Task *task);

	void processRtnHedgeCfm(Task *task);

	void processErrRtnHedgeCfm(Task *task);

	void processErrRtnHedgeCfmAction(Task *task);
	...
	virtual void onRtnPrivateSeqNo(int reqid) {};
	...
	virtual void onRspGenSMSCode(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRspSpdApply(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRspSpdApplyAction(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRspQrySpdApply(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRtnSpdApply(const dict &data) {};

	virtual void onErrRtnSpdApply(const dict &data, const dict &error) {};

	virtual void onErrRtnSpdApplyAction(const dict &data, const dict &error) {};

	virtual void onRspHedgeCfm(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRspHedgeCfmAction(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRspQryHedgeCfm(const dict &data, const dict &error, int reqid, bool last) {};

	virtual void onRtnHedgeCfm(const dict &data) {};

	virtual void onErrRtnHedgeCfm(const dict &data, const dict &error) {};

	virtual void onErrRtnHedgeCfmAction(const dict &data, const dict &error) {};
	...
	int reqGenSMSCode(const dict &req, int reqid);

	int reqSpdApply(const dict &req, int reqid);

	int reqSpdApplyAction(const dict &req, int reqid);

	int reqQrySpdApply(const dict &req, int reqid);

	int reqHedgeCfm(const dict &req, int reqid);

	int reqHedgeCfmAction(const dict &req, int reqid);

	int reqQryHedgeCfm(const dict &req, int reqid);
};
